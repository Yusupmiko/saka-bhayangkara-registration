...
<head>
    ...
    <title>Berkas Anggota Saka Bhayangkara</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="d-flex justify-content-between mb-4">
                <div>
                    <a href="<?= base_url('berkas/tambah'); ?>" class="btn btn-primary">
                        <i class="fas fa-user-plus"></i> Tambah Anggota
                    </a>
                   <?php if ($this->session->userdata('role_id') == 1): ?>
    <a href="<?= base_url('berkas/cetak'); ?>" class="btn btn-outline-success ml-2">
        <i class="fas fa-print"></i> Cetak Laporan
    </a>
<?php endif; ?>

                </div>
                <form action="<?= base_url('berkas/search'); ?>" method="GET" class="form-inline">
...
<tbody>
    <?php $no = 1; foreach($berkas as $item): ?>
    <tr>
        ...
        <td>
            <?php if ($item->unggah_berkas): ?>
                <a href="<?= base_url('uploads/berkas/' . $item->unggah_berkas) ?>" target="_blank" class="badge badge-police">
    ...
    <?php if ($this->session->userdata('role_id') == 1): ?>
        <a href="<?= base_url('berkas/edit/'.$item->id_berkas); ?>" class="btn btn-warning btn-sm" title="Edit">
            <i class="fas fa-edit"></i>
        </a>
        <a href="<?= base_url('berkas/hapus/'.$item->id_berkas); ?>" class="btn btn-danger btn-sm" title="Hapus" onclick="return confirm('Yakin ingin menghapus data anggota ini?');">
